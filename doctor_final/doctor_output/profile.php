                ...
                if ($new_image) {
                    ...
                    if ($stmt) {
                        mysqli_stmt_bind_param($stmt, 'sssiiiisi',
                            ...
                            $experience, $fee, $city_id, $spec_id,
                            $new_image, $doc_id
                        );
...
<head>
  ...
  <style>
    ...
    .info-badge { background:#eef4ff; border:1px solid #d6e4ff; color:#0b3e8a;
      border-radius:10px; padding:6px 10px; font-size:.8rem; font-weight:700; }

    /* Avatar */
    .avatar-wrap { position:relative; width:120px; height:120px; margin:0 auto 12px; }
    .avatar-img { width:120px; height:120px; border-radius:50%; object-fit:cover;
      border:3px solid #e5eef9; box-shadow:0 4px 16px rgba(11,62,138,.12); }
    .avatar-edit { position:absolute; bottom:4px; right:4px;
      width:32px; height:32px; border-radius:50%;
      background:#0b3e8a; color:#fff; border:2px solid #fff;
      display:flex; align-items:center; justify-content:center;
      cursor:pointer; font-size:.78rem; transition:.15s; }
    .avatar-edit:hover { background:#2563eb; }
    .avatar-edit input { display:none; }
    .avatar-name { text-align:center; font-weight:800; color:#0b3e8a; font-size:1rem; }
    .avatar-spec { text-align:center; color:#06b6d4; font-size:.8rem; font-weight:700;
      text-transform:uppercase; letter-spacing:.05em; margin-top:2px; }

    /* Preview */
    #imgPreviewWrap { display:none; text-align:center; margin-top:8px; }
    #imgPreview { width:80px; height:80px; border-radius:50%; object-fit:cover; border:2px solid #2563eb; }
    .img-hint { font-size:.75rem; color:#64748b; text-align:center; margin-top:4px; }
  </style>
  <script>
        ...
        <form method="post" action="" enctype="multipart/form-data">
          ...
          <div class="mb-4 text-center">
            <div class="avatar-wrap">
              ...
              <label class="avatar-edit" title="Change Photo">
                ...
                <input type="file" name="doctor_image" id="imageInput"
          ...
          <div class="row g-3">
            ...
            <div class="col-md-3">
              ...
              <input type="number" name="experience" class="form-control" value="<?= (int)($doctor['experience'] ?? 0) ?>">
            </div>
            <div class="col-md-3">
              <label class="form-label">Consultation Fee</label>
              <input type="number" name="consultation_fee" class="form-control" value="<?= (int)($doctor['consultation_fee'] ?? 0) ?>">
            </div>
            <div class="col-md-6">
    ...
    <div class="col-12 col-lg-4">
      <div class="card-care p-3 p-md-4">
        ...
        <div style="font-size:.88rem;">
          ...
          <div class="mb-1"><strong>Fee:</strong> Rs <?= number_format((int)($doctor['consultation_fee'] ?? 0)) ?></div>
        </div>
        <hr>
