<?php $page_title = 'About Us'; include 'includes/head.php'; ?>
<?php include 'includes/navbar.php'; ?>

  <section class="about-hero">
    <div class="container text-center">
      <span class="badge-accent" style="background:rgba(255,255,255,0.2);color:white;border:1px solid rgba(255,255,255,0.3);">About CARE Group</span>
      <h1 class="hero-title mt-2 mb-3" style="font-size:2.6rem;">Transforming Healthcare<br>Across Pakistan</h1>
      <p style="color:rgba(255,255,255,0.85);max-width:560px;margin:0 auto;font-size:1.05rem;">Founded in 2018, CARE Group is Pakistan's leading digital health platform connecting patients with verified medical specialists.</p>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row g-5 align-items-center">
        <div class="col-lg-6 animate-on-scroll">
          ...
          <p style="color:var(--text-muted);line-height:1.9;margin-bottom:16px;">CARE Group was established with a single mission: to make quality healthcare accessible to every Pakistani. We recognized that finding the right doctor shouldn't be a complicated, time-consuming process.</p>
          <p style="color:var(--text-muted);line-height:1.9;margin-bottom:16px;">Today, we operate across 15 cities with a network of over 500 verified medical specialists, serving more than 50,000 patients. Our platform handles everything from appointment booking to medical record management.</p>
          <p style="color:var(--text-muted);line-height:1.9;">Every doctor on our platform is rigorously verified through Pakistan Medical Commission (PMC) records, ensuring you always receive care from qualified professionals.</p>
          <div class="d-flex flex-wrap gap-4 mt-4">
            <?php $stats=[['500+','var(--primary)','Verified Doctors'],['50K+','var(--accent)','Patients Served'],['15','var(--success)','Cities'],['4.9★','var(--warning)','Avg Rating']];
            foreach ($stats as $s): ?>
            <div><div style="font-size:2rem;font-weight:800;color:<?php echo $s[1]; ?>"><?php echo $s[0]; ?></div><div style="font-size:0.85rem;color:var(--text-muted);"><?php echo $s[2]; ?></div></div>
            <?php endforeach; ?>
          </div>
        </div>
        <div class="col-lg-6 animate-on-scroll" style="transition-delay:.15s;">
          <div style="background:linear-gradient(135deg,var(--light-blue),#E0F7FA);border-radius:var(--radius-lg);padding:40px;text-align:center;">
            ...
            <div class="row g-3 mt-3">
              ...
              <div class="col-6"><div style="background:white;border-radius:var(--radius);padding:16px;box-shadow:var(--shadow-sm);"><i class="fas fa-<?php echo $f[0]; ?>" style="font-size:1.5rem;color:<?php echo $f[1]; ?>;display:block;margin-bottom:8px;"></i><div style="font-size:0.82rem;font-weight:600;color:var(--text-dark);"><?php echo $f[2]; ?></div></div></div>
              <?php endforeach; ?>
            </div>
          </div>
        </div>
      ...
      <div class="row g-4">
        ...
        <div class="col-md-4 animate-on-scroll" style="transition-delay:<?php echo $i*0.1; ?>s">
          <div class="mission-card">
            <div class="mission-icon" style="background:linear-gradient(135deg,<?php echo $m[1]; ?>,<?php echo $m[1]; ?>99);"><i class="fas fa-<?php echo $m[0]; ?>"></i></div>
      ...
      <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-3 animate-on-scroll" style="transition-delay:<?php echo ($i%4)*0.07; ?>s">
          <div class="why-choose-card">
            <div class="why-icon" style="background:<?php echo $f[1]; ?>"><i class="fas fa-<?php echo $f[0]; ?>" style="color:<?php echo $f[2]; ?>"></i></div>
  ...
  <section class="section-padding" style="background:var(--off-white);">
    <div class="container">
      <div class="text-center mb-5">
        ...
        <p class="section-subtitle mt-2">The dedicated professionals driving CARE Group's vision of accessible healthcare.</p>
      </div>
      <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-3 animate-on-scroll" style="transition-delay:<?php echo $i*0.08; ?>s">
          <div class="team-card">
            <div class="team-avatar" style="background:linear-gradient(135deg,<?php echo $t[1]; ?>,<?php echo $t[1]; ?>99);color:<?php echo $t[2]; ?>"><i class="fas fa-<?php echo $t[0]; ?>"></i></div>
            <div class="team-body">
  ...
  <section class="cta-banner">
    <div class="container text-center position-relative" style="z-index:1;">
      ...
      <p class="mb-4" style="max-width:500px;margin:0 auto 2rem;">Whether you're a patient seeking care or a doctor looking to expand your practice, we're here for you.</p>
