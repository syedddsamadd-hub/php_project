...
// Sort
if ($sort_filter === 'fee_asc') usort($doctors, fn($a,$b) => $a['fee'] - $b['fee']);
elseif ($sort_filter === 'exp')  usort($doctors, fn($a,$b) => $b['exp'] - $a['exp']);
else usort($doctors, fn($a,$b) => $b['rating'] <=> $a['rating']);
...
<?php include 'includes/navbar.php'; ?>
  ...
  <section class="search-hero">
    <div class="container text-center">
      <span class="badge-accent" style="background:rgba(255,255,255,0.2);color:white;border:1px solid rgba(255,255,255,0.3);">500+ Verified Doctors</span>
    ...
    <div class="search-filter-box">
      <form method="GET" action="search-doctor.php">
        <div class="row g-3 align-items-end">
          <div class="col-md-3">
            <label class="form-label" style="font-size:0.82rem;font-weight:600;color:var(--text-dark);text-transform:uppercase;letter-spacing:.5px;">
          ...
          <div class="col-md-3">
            ...
            <select class="filter-select" name="spec">
              ...
              <option value="<?php echo $s; ?>" <?php echo ($spec_filter === $s) ? 'selected' : ''; ?>><?php echo $s; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          <div class="col-md-3">
  ...
  <section class="section-padding">
    <div class="container">
      ...
      <?php else: ?>
      <div class="row g-4">
        <?php $i = 0; foreach ($doctors as $doc): $i++; ?>
          ...
          <div class="doctor-card">
            <div class="doctor-card-img" style="background:<?php echo $doc['bg']; ?>">
              ...
              <span class="availability-badge" <?php echo ($doc['avail']==='Busy') ? 'style="background:#FFEBEE;color:var(--danger);border-color:rgba(198,40,40,.2);"' : ''; ?>>
                <i class="fas fa-circle" style="font-size:7px;margin-right:4px;"></i><?php echo htmlspecialchars($doc['avail']); ?>
              </span>
            </div>
            <div class="doctor-card-body">
              ...
              <p class="doctor-meta"><i class="fas fa-map-marker-alt"></i><?php echo htmlspecialchars($doc['city']); ?> &ndash; <?php echo htmlspecialchars($doc['area']); ?></p>
              <div class="d-flex align-items-center justify-content-between mb-3">
                <span class="doctor-fees-badge"><i class="fas fa-tag me-1"></i>Rs. <?php echo number_format($doc['fee']); ?></span>
                <div>
      ...
      <div class="d-flex justify-content-center mt-5">
        <nav>
          <ul class="pagination gap-1">
            <li class="page-item"><a class="page-link" href="?<?php echo http_build_query(array_merge($_GET, ['page'=>1])); ?>" style="border-radius:8px;"><i class="fas fa-chevron-left"></i></a></li>
            <li class="page-item active"><a class="page-link" href="#" style="border-radius:8px;background:var(--primary);border-color:var(--primary);">1</a></li>
            ...
            <li class="page-item"><a class="page-link" href="#" style="border-radius:8px;"><i class="fas fa-chevron-right"></i></a></li>
          </ul>
        </nav>
      </div>
      <?php endif; ?>
